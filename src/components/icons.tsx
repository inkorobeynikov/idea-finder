...
export const Icon = {
  ...
  caret: (p: P = {}) => (
    <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="caret" {...p}>
  ...
  star: (p: P = {}) => (
    <svg width="11" height="11" viewBox="0 0 24 24" fill="currentColor" {...p}>
      <path d="M12 2l3 7 7 .8-5.3 4.8 1.7 7-6.4-3.8L5.6 21.6l1.7-7L2 9.8 9 9z" />
    </svg>
  ),
  sparkles: (p: P = {}) => (
